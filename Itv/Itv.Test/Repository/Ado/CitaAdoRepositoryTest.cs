...
public class CitaAdoRepositoryTest() {
    ...
    public sealed class CasosValidos {
        ...
        public void Update_CitaValida_RetornaSuccess() {
            //Arrange
            var cita = new Cita { Id = 1, Matricula = "1234BBB", Marca = "Toyota", Modelo = "Corolla", Cilindrada = 1800, Motor = Motor.Diesel, DniDueño = "12345678Z", FechaMatriculacion = new DateTime(2022, 05, 10), FechaInspeccion = DateTime.Today, CreateAt = DateTime.Now, UpdateAt = DateTime.Today, IsDelete = false }; 
